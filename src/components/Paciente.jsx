...
const Paciente = ({paciente}) => {
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <p className="font-bold uppercase text-indigo-700 my-2">
        Email Contacto: <span className="font-normal normal-case text-black">{email}</span>
      </p>
      ...
      <div className="flex justify-between my-5">
        ...
        <button
          type="button"
          className="py-2 px-10 bg-red-600 hover:bg-red-700 text-white uppercase font-bold rounded-lg cursor-pointer"
